		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li><a href="controller?command=SORT_PATIENTS&sortBy=name">
							<c:out value="${sortByNameMessage}"></c:out>
					</a></li>
					<li><a href="controller?command=SORT_PATIENTS&sortBy=surname">
							<c:out value="${sortBySurnameMessage}"></c:out>
					</a></li>
					<li><a
						href="controller?command=SORT_PATIENTS&sortBy=diagnosis"> <c:out
