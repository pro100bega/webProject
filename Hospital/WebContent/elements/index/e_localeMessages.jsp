...
<fmt:message bundle="${local}" key="message.begench" var="begenchMessage"/>
<fmt:message bundle="${local}" key="message.shamuradov" var="shamuradovMessage"/>
<fmt:message bundle="${local}" key="message.about" var="aboutMessage"/>
<fmt:message bundle="${local}" key="message.error" var="errorMessage"/>
...
<fmt:message bundle="${local}" key="button.send" var="sendButton"/>
...
<fmt:message bundle="${local}" key="heading.header" var="headerHeading"/>
<fmt:message bundle="${local}" key="heading.message" var="messageHeading"/>
<fmt:message bundle="${local}" key="heading.bugs" var="bugsHeading"/>
<fmt:message bundle="${local}" key="heading.success" var="successHeading"/>
<fmt:message bundle="${local}" key="heading.error" var="errorHeading"/>
...
<fmt:message bundle="${local}" key="placeholder.header" var="headerPlaceholder"/>
<fmt:message bundle="${local}" key="placeholder.message" var="messagePlaceholder"/>